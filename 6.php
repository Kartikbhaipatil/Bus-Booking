    ...
    <div class="bus-container">
        ...
        <div class="bus-card">
            ...
            <div class="bus-info">
                ...
                <p class="route">📍 Mumbai → Hyderabad</p>
        ...
        <div class="bus-card">
            ...
            <div class="bus-info">
                ...
                <p class="route">📍 Mumbai → Kokapet</p>
                <p class="price">₹900</p>
            </div>
            <a href="seat_layout.php"><button class="book-btn">Book Now</button></a>
        </div>
        ...
        <div class="bus-card">
            ...
            <div class="bus-info">
                ...
                <p class="route">📍 Mumbai → Hussain sagar lake</p>
                <p class="price">₹850</p>
            </div>
            <a href="seat_layout.php"><button class="book-btn">Book Now</button></a>
        </div>
        ...
        <div class="bus-card">
            ...
            <div class="bus-info">
                ...
                <p class="route">📍 Mumbai → Golconda fort</p>
         ...
         <div class="bus-card">
            ...
            <div class="bus-info">
                <h3>Orange Travels</h3>
                <p class="time">🕒 07:00 AM → 01:45 PM</p>
                <p class="route">📍 Mumbai → Hyderabad-Birla mandir</p>
                <p class="price">₹1000</p>
            </div>
            <a href="seat_layout.php"><button class="book-btn">Book Now</button></a>
        </div>
         ...
         <div class="bus-card">
            ...
            <div class="bus-info">
                <h3>Orange Travels</h3>
                <p class="time">🕒 07:00 AM → 01:45 PM</p>
                <p class="route">📍 Mumbai → Charminar</p>
                <p class="price">₹1000</p>
            </div>
            <a href="seat_layout.php"><button class="book-btn">Book Now</button></a>
        </div>
